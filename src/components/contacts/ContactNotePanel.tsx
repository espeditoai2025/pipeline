...
export function ContactNotePanel({ contactId, initialNotes }: Props) {
  ...
  return (
    <div className="rounded-xl border border-[var(--crm-neutral-100)] bg-white dark:bg-[#1a1a2e] p-5 space-y-3">
      <Link className="block text-xs text-[var(--crm-primary)] underline" href={"/voice?contactId=" + encodeURIComponent(contactId)}>Nota vocale o comando per questo contatto</Link>
