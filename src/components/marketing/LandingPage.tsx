...
export type LandingFeature = { icon: React.ElementType; color: string; title: string; description: string };
    ...
    <MarketingShell>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 px-6 py-28 text-center">
        ...
        <div className="relative mx-auto max-w-3xl">
          ...
          <h1 className="mb-4 text-4xl font-semibold leading-tight tracking-tight text-white md:text-5xl lg:text-6xl">
            {hero.h1}
          </h1>
          ...
          <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <Link
              href="/register"
              className="flex items-center gap-2 rounded-xl bg-blue-600 px-8 py-3.5 text-base font-semibold text-white shadow-lg shadow-blue-600/30 hover:bg-blue-500 transition-all"
            >
          ...
          <p className="mt-6 text-sm text-slate-500">Gratis per sempre nel piano Starter · Nessuna carta di credito</p>
        </div>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mb-12 text-center text-slate-500">Pipely è stato costruito per risolverli.</p>
      ...
      <section className="bg-slate-50 py-20 px-6">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mb-12 text-center text-slate-500">Dalla prima conversazione alla firma del contratto.</p>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {[
              ...
              <div key={item} className="flex items-start gap-2.5 text-sm text-blue-100">
                <CheckCircle2 className="h-4 w-4 shrink-0 text-teal-300 mt-0.5" />
                {item}
              </div>
            ))}
          </div>
      ...
      <section className="bg-slate-50 py-20 px-6">
        <div className="mx-auto max-w-2xl">
          <h2 className="mb-10 text-center text-3xl font-semibold tracking-tight text-slate-900">Domande frequenti</h2>
