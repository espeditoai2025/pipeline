...
export const MOCK_ACTIVITIES: Activity[] = [
  // Past completed
  { id: "act-1", type: "CALL", subject: "Chiamata di scoperta con Acme", notes: "Ha mostrato interesse per il modulo reportistica", dueDate: daysFromNow(-5, 11), completedAt: daysFromNow(-5, 11), duration: 30, organizationId: "org-1", userId: "owner-1", user: USER, dealId: "deal-1", dealTitle: "Pipely Enterprise Acme", contactId: "cnt-1", contactName: "Luca Bianchi", createdAt: daysFromNow(-6) },
  ...
  // Tomorrow
  { id: "act-6", type: "MEETING", subject: "Pranzo con CTO di Acme", notes: "Ristorante Il Portico, ore 13:00", dueDate: daysFromNow(1, 13), completedAt: null, duration: 90, organizationId: "org-1", userId: "owner-1", user: USER, dealId: "deal-1", dealTitle: "Pipely Enterprise Acme", contactId: "cnt-1", contactName: "Luca Bianchi", createdAt: daysFromNow(0) },
  ...
  { id: "act-12", type: "TASK", subject: "Aggiornare forecast Q3 su Pipely", notes: null, dueDate: daysFromNow(9, 16), completedAt: null, duration: null, organizationId: "org-1", userId: "owner-1", user: USER, dealId: null, dealTitle: null, contactId: null, contactName: null, createdAt: daysFromNow(0) },
];
