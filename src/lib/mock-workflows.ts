...
export const MOCK_WORKFLOW_LOGS: WorkflowLog[] = [
  ...
  { id: "log-4", workflowId: "wf-1", workflowName: "Follow-up automatico dopo proposta", status: "FAILED", trigger: "Affare spostato in Proposta", entityType: "deal", entityId: "deal-1", entityLabel: "CRM Enterprise Acme", stepsExecuted: 1, error: "Email non inviata: contatto senza email", executedAt: daysAgo(5) },
