...
export const GUIDE_SECTIONS: GuideSection[] = [
  ...
  },
  {
    ...
    articles: [
      { id: "l1", title: "Cos'è un lead in Pipely e come crearlo", excerpt: "Differenza tra lead e affare; come aggiungere un nuovo lead e assegnargli uno score.", readTime: 4, popular: true, blocks: [
        ...
        { type: "list", items: [
          "Nome e Email — identificano il prospect",
          "Telefono — per contatti diretti",
          "Score — valore numerico 0-100 per prioritizzare",
          "Fonte — da dove proviene il lead (es. Sito web, Evento, Referral)",
      ...
      { id: "l2", title: "Qualificare un lead: stati e workflow", excerpt: "Gli stati NEW, WORKING, NURTURING, CONVERTED e come passare da uno all'altro.", readTime: 5, blocks: [
        ...
        { type: "list", items: [
          "NEW — lead appena creato, non ancora lavorato",
          "WORKING — il responsabile sta attivamente qualificando il lead",
          "NURTURING — lead non ancora pronto, da coltivare nel tempo",
          "CONVERTED — lead qualificato e trasformato in affare",
          "LOST — lead perso, non interessato o non raggiungibile",
        ]},
      ...
      { id: "l3", title: "Convertire un lead in affare", excerpt: "Come trasformare un lead qualificato in un affare nella pipeline.", readTime: 3, popular: true, blocks: [
        ...
        { type: "tip", text: "Dopo la conversione il lead non viene eliminato: puoi sempre tornare alla scheda lead per vedere da dove è partita la trattativa." },
      ]},
