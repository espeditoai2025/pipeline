...
export const GUIDE_SECTIONS: GuideSection[] = [
  {
    ...
    articles: [
      { id: "i1", title: "Come creare il tuo account Pipely", excerpt: "Guida passo-passo alla registrazione e configurazione iniziale del tuo CRM.", readTime: 3, popular: true, blocks: [
        ...
        { type: "tip", text: "Se un collega ti ha invitato, apri il link dell'invito invece di registrarti da zero: entri direttamente nella sua organizzazione con il ruolo che ti ha assegnato." },
  ...
  },
  {
    ...
    description: "Trova lead, qualificali e convertili in affari",
    articles: [
      { id: "l0", title: "Lead Finder: trovare aziende da contattare", excerpt: "Descrivi il cliente ideale e Pipely cerca aziende reali dal registro imprese e da Google Maps, con i contatti verificati.", readTime: 6, popular: true, blocks: [
        { type: "heading", text: "Cosa fa" },
        { type: "para", text: "Indichi zona, settore e qualche parola chiave; Pipely raccoglie aziende dal registro delle imprese e da Google Maps, scarta quelle che non corrispondono ai criteri e restituisce un elenco di candidati da valutare, con partita IVA, indirizzo, settore e i contatti che riesce a verificare." },
        { type: "heading", text: "Come si usa" },
        { type: "steps", items: [
          "Apri Lead Finder e crea una nuova ricerca",
          "Indica la località, il settore e le parole chiave che descrivono il cliente ideale",
          "Scegli quanti candidati vuoi ottenere e avvia: la ricerca richiede qualche minuto",
          "Scorri i candidati e approva quelli utili: diventano lead nel CRM",
        ]},
        { type: "heading", text: "Da dove arrivano i contatti" },
        { type: "para", text: "Ogni email, telefono e sito porta l'indicazione della propria origine, così sai di quali fidarti: \"verificato\" quando il dato viene dal sito aziendale, dalla PEC, da Google Maps o dal registro; \"da verificare\" quando è stato proposto dall'AI e non è stato possibile confermarlo." },
        { type: "heading", text: "Limiti per piano" },
        { type: "list", items: [
          "Starter: una ricerca al giorno, fino a 10 candidati per ricerca",
          "Pro ed Enterprise: ricerche senza limite giornaliero, fino a 50 candidati per ricerca",
        ]},
        { type: "warning", text: "I candidati sono aziende reali raccolte da fonti pubbliche, ma i contatti proposti dall'AI vanno controllati prima di scrivere: un indirizzo segnato \"da verificare\" può essere sbagliato." },
        { type: "tip", text: "Ripetere la ricerca sulla stessa località non ripropone le aziende già trovate: Pipely riprende da dove aveva lasciato." },
      ]},
    ...
    articles: [
      { id: "im1", title: "Modificare il profilo personale", excerpt: "Aggiorna nome, email, foto profilo e preferenze di notifica.", readTime: 3, blocks: [
        ...
        { type: "list", items: [
          ...
          "Fuso orario — usato per le scadenze delle attività e per i limiti giornalieri",
          "Password — cambiala qui; il salvataggio chiude tutte le altre sessioni aperte",
        ]},
  ...
  },
  {
    ...
    articles: [
      { id: "s1", title: "Cambiare la password del tuo account", excerpt: "Come aggiornare la password e scegliere una credenziale sicura.", readTime: 2, blocks: [
        ...
        { type: "heading", text: "Se cambi la password" },
        { type: "para", text: "Cambiando la password vengono chiuse tutte le sessioni aperte, su ogni dispositivo: chi conosceva la vecchia password viene disconnesso subito. Lo stesso effetto si ottiene con \"Disconnetti da tutti i dispositivi\" in Impostazioni → Profilo." },
      ...
      { id: "s2", title: "Attivare l'autenticazione a due fattori (2FA)", excerpt: "Proteggi il tuo account con un secondo livello di verifica via app o SMS.", readTime: 5, blocks: [
        { type: "heading", text: "Verifica in due passaggi" },
        { type: "para", text: "L'accesso a Pipely avviene con email e password: la verifica in due passaggi non è ancora disponibile. Nel frattempo usa una password lunga e non riutilizzata, e disconnetti le sessioni che non riconosci da Impostazioni → Profilo." },
        { type: "para", text: "La verifica in due passaggi è in roadmap e al momento non è disponibile. Quello che puoi fare subito conta comunque parecchio." },
        { type: "list", items: [
          "Usa una password lunga e mai riutilizzata su altri servizi",
          "Cambiala se sospetti che qualcuno la conosca: il salvataggio chiude tutte le sessioni aperte, ovunque",
          "Assegna il ruolo minimo necessario ai colleghi: solo Owner e Admin possono gestire team e fatturazione",
          "Rimuovi dal team chi non lavora più con te: la revoca ha effetto sulla richiesta successiva",
        ]},
        { type: "tip", text: "Gli accessi e le richieste di reset password sono limitati per indirizzo IP: dopo dieci tentativi in un minuto le richieste vengono respinte, il che rende inefficaci i tentativi automatici." },
      ]},
      { id: "s3", title: "Gestione delle sessioni attive", excerpt: "Visualizza i dispositivi connessi e disconnetti le sessioni sospette.", readTime: 3, blocks: [
        ...
        { type: "list", items: [
          ...
          "Sessione bloccata su un dispositivo che non hai più: cambia la password oppure usa \"Disconnetti da tutti i dispositivi\" in Impostazioni → Profilo, poi accedi di nuovo.",
        ]},
  ...
  },
  {
    ...
    articles: [
      { id: "in1", title: "Panoramica delle integrazioni disponibili", excerpt: "Scopri tutte le app che puoi collegare a Pipely: Gmail, Slack, Zapier e altro.", readTime: 4, blocks: [
        ...
        { type: "list", items: [
          "Password cifrate con bcrypt e sessioni revocate su tutti i dispositivi quando la password cambia",
      ...
      { id: "in4", title: "Integrazione con Google Calendar", excerpt: "Sincronizza le attività di Pipely con il tuo calendario Google.", readTime: 5, blocks: [
        ...
        { type: "para", text: "L'integrazione è attiva: collegando il tuo account Google le attività di Pipely finiscono nel tuo calendario, senza esportazioni manuali." },
        { type: "heading", text: "Come collegarlo" },
        { type: "steps", items: [
          "Apri la pagina Attività",
          "Clicca \"Collega Google Calendar\" e scegli l'account Google da usare",
          "Autorizza Pipely: la connessione vale per il tuo utente, non per tutta l'organizzazione",
          "Da quel momento le attività che crei finiscono anche nel calendario collegato",
        ]},
        { type: "tip", text: "Puoi staccare il collegamento quando vuoi dalla stessa pagina. I token di accesso sono cifrati prima di essere salvati." },
      ]},
    ...
    articles: [
      { id: "mo1", title: "Scaricare l'app Pipely su iPhone e Android", excerpt: "Link agli store e requisiti minimi di sistema per l'app mobile.", readTime: 2, blocks: [
        ...
        { type: "steps", items: [
          ...
          "Vai su pipely.it e accedi al tuo account",
      ...
      { id: "mo6", title: "Problemi comuni sull'app mobile", excerpt: "Soluzioni per crash, errori di login e problemi di sincronizzazione su mobile.", readTime: 5, blocks: [
        ...
        { type: "heading", text: "La registrazione vocale non parte" },
        { type: "para", text: "Le note vocali usano il microfono del browser: su iPhone serve Safari e il permesso al microfono va concesso in Impostazioni → Safari → Microfono. In navigazione privata alcuni browser bloccano la registrazione." },
  ...
  },
  {
    ...
    description: "Fattura elettronica, abbonamenti e gestione del piano",
    articles: [
      { id: "fa0", title: "Collegare Fatture in Cloud ed emettere una fattura", excerpt: "Collega il gestionale, crea il documento dai dati di Pipely e invialo allo SdI senza reinserire nulla.", readTime: 6, popular: true, blocks: [
        { type: "heading", text: "Cosa fa l'integrazione" },
        { type: "para", text: "Pipely non emette fatture per conto suo: prepara il documento con i dati che hai già nel CRM e lo crea su Fatture in Cloud, da cui parte l'invio allo SdI. Il numero, la numerazione e lo stato fiscale restano quelli del gestionale." },
        { type: "heading", text: "Collegamento" },
        { type: "steps", items: [
          "Vai in Impostazioni → Fatturazione elettronica",
          "Autorizza Pipely sul tuo account Fatture in Cloud",
          "Scegli l'azienda da collegare fra quelle che il gestionale ti mostra",
          "La partita IVA dell'azienda scelta deve coincidere con quella in Impostazioni → Organizzazione, altrimenti il collegamento viene rifiutato",
        ]},
        { type: "heading", text: "Emettere una fattura" },
        { type: "steps", items: [
          "Apri la fattura in Pipely: deve essere in stato Bozza",
          "Genera l'anteprima e controlla dati del destinatario, righe e aliquote",
          "Conferma la creazione: il documento nasce su Fatture in Cloud",
          "Da lì invialo allo SdI: lo stato di invio torna visibile in Pipely",
        ]},
        { type: "heading", text: "Se qualcosa va storto" },
        { type: "list", items: [
          "Un invio dall'esito incerto resta segnalato come tale: usa \"Aggiorna stato\" per rileggere la situazione reale dal gestionale invece di riprovare alla cieca",
          "Una fattura già inviata non torna mai nello stato \"da inviare\": l'invio allo SdI non si ripete per errore",
          "Le righe senza IVA vanno completate nel gestionale, perché natura e bollo non sono gestiti da Pipely",
        ]},
        { type: "warning", text: "L'integrazione richiede un piano Pro o Enterprise. Con il piano Starter la sezione resta visibile ma non consente di creare documenti." },
        { type: "tip", text: "Puoi cambiare azienda collegata finché non hai creato documenti reali su quella precedente: le anteprime e i tentativi non riusciti non bloccano il cambio." },
      ]},
  ...
  {
    id: "voce",
    label: "Note vocali e comandi",
    description: "Detta una nota, falla trascrivere e chiedi all'AI di aggiornare il CRM",
    articles: [
      { id: "v1", title: "Registrare una nota vocale dopo una visita", excerpt: "Detta il resoconto invece di scriverlo: la nota resta collegata all'affare o al contatto.", readTime: 4, popular: true, blocks: [
        { type: "heading", text: "A cosa serve" },
        { type: "para", text: "Dopo una visita o una telefonata è più veloce parlare che scrivere. Registri la nota dal telefono, la colleghi all'affare o al contatto e la ritrovi nella scheda, insieme alla trascrizione." },
        { type: "heading", text: "Come si registra" },
        { type: "steps", items: [
          "Apri la sezione Note vocali dal menu",
          "Premi il pulsante di registrazione e concedi al browser l'accesso al microfono",
          "Parla: la registrazione può durare al massimo 2 minuti",
          "Dai un titolo alla nota e scegli se collegarla a un affare oppure a un contatto",
          "Salva: la nota compare nell'elenco e nella scheda del record collegato",
        ]},
        { type: "heading", text: "Limiti" },
        { type: "list", items: [
          "Durata massima 2 minuti per nota, dimensione massima 3 MB",
          "Spazio complessivo 50 MB per organizzazione",
          "Numero di note conservate: 10 con il piano Starter, 100 con Pro ed Enterprise",
          "Formati accettati: quelli registrati dal browser (webm, m4a, mp3, ogg, wav)",
        ]},
        { type: "tip", text: "Una nota può essere collegata a un affare oppure a un contatto, non a entrambi. Se sbagli, cambi il collegamento dalla nota senza doverla registrare di nuovo." },
        { type: "warning", text: "L'audio è salvato nel database dell'organizzazione e non viene cancellato quando elimini l'affare collegato: in quel caso la nota resta, senza collegamento." },
      ]},
      { id: "v2", title: "Trascrivere una nota vocale", excerpt: "La trascrizione automatica trasforma l'audio in testo cercabile. Richiede un piano con AI.", readTime: 3, blocks: [
        { type: "heading", text: "Come funziona" },
        { type: "para", text: "Dalla nota registrata scegli \"Trascrivi\": l'audio viene inviato al servizio di trascrizione e il testo torna nella nota, dove puoi correggerlo a mano." },
        { type: "heading", text: "Quanto puoi usarla" },
        { type: "para", text: "Trascrizioni e comandi CRM condividono lo stesso limite: 50 elaborazioni AI al giorno per organizzazione. Se una trascrizione fallisce per un problema del servizio, l'elaborazione ti viene restituita e non consuma il limite." },
        { type: "list", items: [
          "Serve un piano che includa l'AI: Pro o Enterprise",
          "La lingua attesa è l'italiano",
          "Una nota già trascritta non viene rielaborata: la seconda richiesta restituisce il testo esistente",
        ]},
        { type: "tip", text: "Se il servizio non è disponibile la registrazione resta salvata: puoi riprovare più tardi oppure scrivere il testo a mano." },
      ]},
      { id: "v3", title: "Comandi CRM: chiedere all'AI di aggiornare un record", excerpt: "Scrivi cosa è successo in parole tue; Pipely propone le modifiche e le applica solo dopo la tua conferma.", readTime: 5, popular: true, blocks: [
        { type: "heading", text: "Come funziona" },
        { type: "para", text: "Dalla scheda di un affare o di un contatto scrivi un comando in italiano, per esempio \"chiamato oggi, sposta in negoziazione e ricordamelo lunedì alle 10\". L'AI propone le azioni corrispondenti; tu leggi l'anteprima e confermi." },
        { type: "heading", text: "Cosa può proporre" },
        { type: "list", items: [
          "Aggiungere una nota al record",
          "Creare un'attività con tipo (chiamata, incontro, email, compito, scadenza, pranzo) e scadenza",
          "Aggiornare un affare: stato vinto/perso/aperto, valore, fase della pipeline",
        ]},
        { type: "heading", text: "Le regole di sicurezza" },
        { type: "list", items: [
          "Il comando vale solo per il record che hai aperto: l'AI non può toccarne altri",
          "Nessuna modifica viene applicata senza la tua conferma esplicita",
          "Al massimo 5 azioni per comando",
          "Se il record cambia mentre stai confermando, l'operazione viene annullata e devi rileggere la proposta",
          "Confermare due volte lo stesso comando non duplica le modifiche",
        ]},
        { type: "warning", text: "L'AI propone, non decide: rileggi sempre l'anteprima prima di confermare, soprattutto quando il comando cambia il valore o lo stato di un affare." },
        { type: "tip", text: "I comandi consumano lo stesso limite giornaliero delle trascrizioni: 50 elaborazioni al giorno per organizzazione." },
      ]},
    ],
  },
  {
    ...
    articles: [
      { id: "pb1", title: "Non riesco ad accedere al mio account", excerpt: "Procedura di recupero password e sblocco account dopo troppi tentativi.", readTime: 3, popular: true, blocks: [
        { type: "heading", text: "Accesso con email e password" },
        { type: "steps", items: [
