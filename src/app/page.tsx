      ...
      <main id="main-content">
        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 px-6 py-28 text-center">
          <div className="pointer-events-none absolute inset-0">
            <div className="absolute top-0 left-1/2 h-[600px] w-[800px] -translate-x-1/2 rounded-full bg-blue-600/20 blur-3xl" />
            <div className="absolute top-1/2 right-0 h-[400px] w-[400px] -translate-y-1/2 rounded-full bg-teal-500/10 blur-3xl" />
          </div>
          ...
          <div className="relative mx-auto max-w-4xl">
            ...
            <h1 className="mb-3 text-5xl leading-tight font-semibold tracking-tight text-white md:text-6xl lg:text-7xl">
              CRM Italiano con AI{" "}
            ...
            <p className="mb-4 text-2xl font-medium tracking-tight text-white/70">
            ...
            <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
              <Link
                href="/register"
                className="flex items-center gap-2 rounded-xl bg-blue-600 px-8 py-3.5 text-base font-semibold text-white shadow-lg shadow-blue-600/30 transition-all hover:bg-blue-500 hover:shadow-blue-500/40"
              >
                Inizia gratis
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              {features.map((f) => (
                <article
                  key={f.title}
                  className="group rounded-2xl border border-slate-100 bg-white p-6 shadow-sm transition-all hover:border-slate-200 hover:shadow-md"
                >
                  <div
        ...
        <section
          id="automations"
          className="bg-gradient-to-br from-slate-900 via-fuchsia-950 to-slate-900 px-6 py-24"
        >
          <div className="mx-auto max-w-6xl">
            ...
            <div className="grid items-center gap-12 md:grid-cols-2">
              <div>
                <h2 className="mb-6 text-4xl leading-tight font-semibold tracking-tight text-white">
                  Configura una volta.{" "}
                ...
                <p className="mb-8 text-lg leading-relaxed text-slate-300">
                  I workflow di Pipely non sono solo configurazioni — eseguono azioni reali: inviano
                  email, creano attività nel calendario, spostano deal tra stage e notificano il
                  team.
                </p>
              ...
              <div className="space-y-3">
                {automationSteps.map((step, i) => (
                  <div
                    key={i}
                    className="rounded-xl border border-white/10 bg-slate-800/50 p-4 backdrop-blur-sm"
                  >
                    ...
                    <div className="ml-8 space-y-1.5">
                      {step.actions.map((action) => (
                        ...
                        >
                          <ArrowRight className="h-3 w-3 shrink-0 text-fuchsia-500/60" />
                          {action}
                        </div>
                      ))}
                    </div>
                ...
                <div className="rounded-xl border border-fuchsia-500/20 bg-fuchsia-900/10 px-4 py-3 text-center text-xs text-fuchsia-300">
          ...
          <div className="mx-auto max-w-5xl">
            <div className="grid items-center gap-12 md:grid-cols-2">
              <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <div className="mt-4 flex items-center gap-2 rounded-lg border border-emerald-100 bg-emerald-50 px-4 py-2.5">
                  <MousePointerClick className="h-4 w-4 shrink-0 text-emerald-600" />
                  <span className="text-xs text-emerald-700">
                    Tracking aperture e click in tempo reale per ogni campagna
                  </span>
                </div>
              </div>
          ...
          <div className="mx-auto max-w-6xl">
            <div className="grid items-center gap-12 md:grid-cols-2">
              <div>
                ...
                <p className="mb-8 text-lg leading-relaxed text-slate-300">
                  Chiedi in linguaggio naturale con i tuoi dati reali. Forecast revenue, deal a
                  rischio, bozze email personalizzate — tutto in pochi secondi.
                </p>
                <ul className="space-y-3">
                  {[
              ...
              <div className="rounded-2xl border border-white/10 bg-slate-800/50 p-4 backdrop-blur-sm">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex gap-2">
                    ...
                    <div className="max-w-[85%] rounded-2xl rounded-tl-sm bg-slate-700/80 px-3.5 py-2.5 text-sm text-slate-200">
                  ...
                  <div className="flex gap-2">
                    ...
                    <div className="max-w-[85%] rounded-2xl rounded-tl-sm bg-slate-700/80 px-3.5 py-2.5 text-sm text-slate-200">
                      ...
                      abbiamo inviato…
                      <span className="mt-1 block cursor-pointer text-xs text-teal-400 hover:underline">
                        Continua a leggere →
                      </span>
                    </div>
                  </div>
          ...
          <div className="mx-auto max-w-5xl">
            <div className="mb-16 text-center">
              ...
              <p className="mt-3 text-slate-500">
                Inizia gratis. Passa a Pro quando hai bisogno di più potenza.
              </p>
            </div>
                  ...
                  <div className="mb-6">
                    ...
                    {"originalPrice" in plan && plan.originalPrice && (
                      <div className="mt-1 flex items-center gap-2">
                        <span className="text-sm text-blue-300/70 line-through">
                          {plan.originalPrice}
                        </span>
                        <span className="rounded-full border border-teal-400/40 bg-teal-400/20 px-2 py-0.5 text-xs font-semibold text-teal-300">
                          In offerta
                        </span>
                      </div>
                    )}
                    ...
                    <div
                      className={`mt-1 text-sm ${plan.highlight ? "text-blue-200" : "text-slate-500"}`}
                    >
                      {plan.description}
                    </div>
                  </div>
          ...
          <div className="mx-auto max-w-3xl">
            ...
            <div className="space-y-3">
              {faqs.map((faq) => (
                <details
                  key={faq.q}
                  className="group cursor-pointer rounded-xl border border-slate-200 bg-white px-6 py-4 transition-shadow open:shadow-sm"
                >
