...
export const CRM_MODES: Record<CrmModeId, CrmMode> = {
  ...
  IMMOBILIARE: {
    id: "IMMOBILIARE",
    name: "Immobiliare",
    description: "Per agenti e agenzie immobiliari: gestisci immobili, acquirenti e venditori",
    ...
    features: [
      ...
      "🔧 Pipeline acquirenti / venditori (prossimamente)",
    ],
    dealLabel: "Trattativa immobiliare",
    leadLabel: "Acquirente / venditore",
    hint: "Agenzie immobiliari",
    comingSoon: "Schede immobile, pipeline dedicata acquirenti/venditori",
  },
  ASSICURAZIONI: {
    id: "ASSICURAZIONI",
    name: "Assicurazioni",
